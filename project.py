...
def semi_pretraining(X_train, y_train, X_test, y_test, n_unlabelled):
    ...
    autoencoder.fit(X_unlabelled, X_unlabelled, epochs=10, batch_size=32, validation_split=0.2)
...
y_pred_list =[ pretrain_50, pretrain_75, pretrain_90, pretrain_99]
# labels = ['Supervised Learning',
#           'Self_50', 'Self_75', 'Self_95', 'Self_99',
#           'Co_50', 'Co_75', 'Co_95', 'Co_99',
#           'Boost_50', 'Boost_75', 'Boost_90', 'Boost_99',
labels = ['Pretrain_50', 'Pretrain_75', 'Pretrain_90', 'Pretrain_99']
